...
private:
    ...
    uint8_t soft_write( uint8_t dev_addr, uint8_t reg_addr, uint8_t data_len, uint8_t const* data_buf);
    uint8_t soft_read( uint8_t dev_addr, uint8_t reg_addr, uint8_t data_len, uint8_t* data_buf);
public:
